...
router.put("/resetLifespan", users.resetLifespan)
router.get("/countStudents", users.countStudents)
...
router.post("/checkQuestionSimilarity", questions.checkQuestionSimilarity);
...
router.get("/countPendingAccounts", webusers.countPendingAccounts)
...
router.put("/deleteBranch", branches.deleteBranch);
router.put("/activateBranch", branches.activateBranch);
